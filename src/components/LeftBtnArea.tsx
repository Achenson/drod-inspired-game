...
function LeftBtnArea({boardWidth, handleKeyDown}: Props): JSX.Element{
    return (
        <div style={{ width: `${boardWidth/2}px`}} className="my-4" >
           
           <div className="flex justify-start">
               <button className="h-10 w-12  bg-gray-400 relative">
                <TurnAnticlockwise className="h-8 absolute" style={{left: "-200px", marginTop: "-15px"}}/>
               </button>
                <button className="h-10 w-12 mx-2 bg-gray-400 relative">
                <TurnClockwise className="h-8 absolute" style={{transform: "scaleX(-1)", left: "-200px", marginTop: "-15px"}}/>
                </button>
           </div>
